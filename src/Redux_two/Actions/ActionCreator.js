...
// export const incrementDecrementQuestion = (data) => (dispatch) => ({
//   type: ActionTypes.INCRMENT_QUESTION,
//   payload: data,
// });


// export const incrementQuestion = (data) => (dispatch) => {
//   dispatch(incr_Question(data));
// };
  ...
  // export const update_question_data = (data) =>(dispatch) => dispatch(updateQ(data));
