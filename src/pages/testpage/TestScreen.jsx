...
class TestScreen extends React.Component {
    ...
    submitAnswer = async () => { 
      ...
      const url = await submitAnswerApi();
          const body = {
              ...
              answer : this.props.IncrementDecrement.currentQuestionAnswer[0],
              // ismobile:false
          }
    ...
    //         setTimeout(() => {
    //           console.log("submit answeer body --- ",body);
    //         }, 3000);
    ...
    return (
      ...
      <div>
        <section
          className="card col-12 col-sm-12 col-md-12 col-lg-8 content p-0 m-auto testAllContent"
        ...
        >
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-12 header mt-3 pt-3">
              ...
              {  <div
                ...
                <div className=" p-2 mt-1">
                  {
                    this.state.submitBtn ?  <CircularProgress  
                    style={{
                      // color:info.allInfo.subject_text_color
                      color:"#000084"
                    }} /> :
          ...
          {this.state.isQuestionLoading ? (
            ...
            <div
              className="col-12 col-sm-12 col-lg-12 m-auto pt-3"
              style={{ 
                // textColor: info.allInfo.subject_button_color
                color:"black"
               }}
            >
              {
  ...
  export default connect(mapStateToProps,mapDispatchToProps) (Small(withRouter(TestScreen)))