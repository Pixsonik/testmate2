...
const TestFinishForFullSem = (props) => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      // console.log("info data --- ",props.questionArray);
    }, 3000);
  }, []);
  ...
  const navigateToShowAnswer = () => {
    navigate("/testScreenForFullSemesterAnswer", {
      state: {
        id: info.id,
        chapterId: info.chapterId,
        levelName: info.levelName,
        test_level: info.test_level,
...
export default TestFinishForFullSem;
