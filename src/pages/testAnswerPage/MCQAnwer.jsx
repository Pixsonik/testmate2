...
class MCQAnwer extends React.Component {
                    ...
                    <div md={3} className=" col-lg-6 col-sm-12 mt-3">
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: this.state.answerId  === data.option_id ? '#0f9d58' : this.state.selectedOptionId  === data.option_id ? '#db4437': this.state.option_color,
                        }}
...
export default connect(mapStateToProps,mapDispatchToProps)(MCQAnwer)
